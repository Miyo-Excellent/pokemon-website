...
export const PokemonCardSkeleton = ({}: PokemonCardSkeletonProps) => {
  return (
    <div
      role="status"
      className="w-[250px] h-[350px] p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
    >
